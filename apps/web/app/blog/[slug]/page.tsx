    ...
    <main className="hydro-section">
      <Container>
        ...
        <article className="mx-auto max-w-4xl">
          ...
          <h1 className="mt-4 text-[clamp(38px,4.5vw,64px)] font-extrabold leading-[1.04] tracking-[-0.045em]">{post.title}</h1>
          <p className="mt-5 text-xl text-hydro-muted">{post.excerpt}</p>
          <div className="mt-10 grid gap-6 text-hydro-muted">
            <p>{post.body}</p>
            <h2 className="text-2xl font-extrabold text-hydro-ink">What teams should evaluate</h2>
            ...
            <h2 className="text-2xl font-extrabold text-hydro-ink">Related HYDROscope areas</h2>
          </div>
