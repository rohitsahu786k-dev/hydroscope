    ...
    <main className="hydro-section">
      <Container>
        ...
        <article className="mx-auto max-w-4xl">
          ...
          <h1 className="mt-4 text-[clamp(38px,4.5vw,64px)] font-extrabold leading-[1.04] tracking-[-0.045em]">{study.title}</h1>
          <p className="mt-5 text-xl text-hydro-muted">{study.excerpt}</p>
          <div className="mt-8 grid gap-5">
            <Card className="p-6"><h2 className="font-extrabold">Challenge</h2><p className="mt-2 text-hydro-muted">{study.challenge}</p></Card>
            <Card className="p-6"><h2 className="font-extrabold">Solution</h2><p className="mt-2 text-hydro-muted">{study.solution}</p></Card>
            <Card className="p-6"><h2 className="font-extrabold">Results note</h2><p className="mt-2 text-hydro-muted">{study.resultsNote}</p></Card>
          </div>
        </article>
      </Container>
