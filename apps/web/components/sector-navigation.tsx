...
/* The thin strip directly under the hero. Four sectors, split by hairlines,
   each linking into the solution that serves it. */
          ...
          {sectorNavigation.map((sector, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={sector.href}
                  className="flex items-center justify-center gap-3 px-4 py-5 text-[12px] font-semibold uppercase tracking-[0.16em] text-hydro-ink transition hover:text-hydro-blue max-sm:text-[11px]"
                >
