...
const stakeholders = ["Government", "State PHED/RWS Dept.", "District administration", "Village panchayat", "Operator", "Citizens"];

const capacities = [
  ["HSE 100", "100 g/day", "1,00,000 litres/day"],
  ["HSE 200", "200 g/day", "2,00,000 litres/day"],
  ["HSE 500", "500 g/day", "5,00,000 litres/day"],
  ["HSE 1000", "1000 g/day", "10,00,000 litres/day"],
  ["HSE 2000", "2000 g/day", "20,00,000 litres/day"]
];
  ...
  return (
    <section className="hydro-section bg-white">
      <Container>
        ...
        <Card className="border-transparent bg-white px-0 py-8 shadow-none">
          <div className="grid min-h-[430px] grid-cols-[0.95fr_1.05fr] items-center gap-14 max-lg:grid-cols-1 max-lg:gap-9">
            <div className="max-w-[560px]">
              ...
              <h3 className="mt-5 text-[clamp(36px,4vw,58px)] font-normal leading-[1.02] tracking-[-0.04em] text-black">
                  ...
                  <div key={label} className="flex min-h-[138px] flex-col justify-between rounded-md border border-[#dedede] bg-white p-6">
                    ...
                    <div>
                      <div className="flex items-baseline gap-3">
                        <p className="text-[clamp(34px,3vw,44px)] font-normal leading-none tracking-[-0.04em] text-black">{value}</p>
        ...
        <section aria-labelledby="key-features-heading" className="mt-8">
          <div className="mb-8 max-w-2xl">
            ...
            <h3
              ...
              className="mt-3 text-[clamp(30px,4vw,56px)] font-bold tracking-tighter text-hydro-ink"
            >
              Key features.
            </h3>
          </div>
        ...
        <div className="mt-8 grid grid-cols-[0.95fr_1.05fr] gap-6 max-xl:grid-cols-1">
          <Card className="border-[#dbe8f5] bg-white p-7">
            <div>
              <p className="mb-4 text-sm font-extrabold uppercase tracking-[0.14em] text-hydro-blue">Stakeholders</p>
              <div className="grid grid-cols-6 gap-2 max-lg:grid-cols-3 max-sm:grid-cols-2">
                {stakeholders.map((item, index) => (
                  <div key={item} className="border border-[#dbe8f5] bg-[#f8fbff] p-3 text-center">
                    <span className="mx-auto mb-2 grid h-8 w-8 place-items-center rounded-full bg-white text-xs font-extrabold text-hydro-blue shadow-hydro">{index + 1}</span>
                    <p className="text-xs font-bold text-hydro-ink">{item}</p>
                  </div>
                ))}
              </div>
            </div>
